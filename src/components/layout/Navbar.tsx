...
export const Navbar = () => {
  ...
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      if (e.key === 'Escape') { setIsSearchOpen(false); setIsAccountOpen(false); }
    };
  ...
  return (
    <>
      <div id="main-navbar" className="w-full fixed top-0 z-40 transition-all duration-700">
        {/* Announcement Bar */}
        ...
        {/* Main Nav */}
        <nav className={`w-full transition-all duration-700 ease-[cubic-bezier(0.4,0,0.2,1)] border-b ${
          isScrolled
          ...
          <div className="max-w-7xl mx-auto h-full px-6 sm:px-8 lg:px-12">
            <div className="flex items-center justify-between h-full">
              ...
              <Link href="/" className="flex-shrink-0 transition-all duration-500 hover:opacity-80 hover:scale-[1.02] group">
                <Image src="/images/alinaLogoo.png" alt="Alina" width={130} height={42}
                  className="object-contain drop-shadow-sm transition-transform duration-500 group-hover:scale-105" priority />
              </Link>
              ...
              <div className="hidden md:flex items-center gap-0.5">
                ...
                <div ref={searchRef} className="flex items-center">
                  <div style={{ width: isSearchOpen ? '240px' : '0px' }}
                  ...
                  <button onClick={() => setIsSearchOpen((v) => !v)}
                    ...
                    className={`p-3 rounded-full transition-all duration-500 group hover:scale-110 active:scale-95 ${
                      isSearchOpen ? 'text-[#742709] bg-[#742709]/8' : 'text-[#1C1B1B] hover:text-[#742709] hover:bg-[#742709]/5'
                    }`}>
                ...
                <div ref={accountRef} className="relative">
                  <button
                    ...
                    className={`p-3 rounded-full transition-all duration-500 hover:scale-110 active:scale-95 ${
                      isAccountOpen ? 'text-[#742709] bg-[#742709]/8' : 'text-[#1C1B1B] hover:text-[#742709] hover:bg-[#742709]/5'
                    }`}
                  >
                  ...
                  {/* Dropdown panel */}
                  <div className={`absolute right-0 top-[calc(100%+8px)] w-[220px] bg-[#FFFCF9] border border-[#742709]/8 shadow-[0_16px_48px_-8px_rgba(116,39,9,0.15)] transition-all duration-300 origin-top-right ${
                    ...
                    <div className="px-5 py-4 border-b border-[#742709]/6">
                      <p className="text-[9px] font-bold tracking-[0.35em] uppercase text-[#742709]/60">My Account</p>
                      <p className="text-[12px] font-medium text-[#1C1B1B]/50 mt-0.5 tracking-wide">Welcome to Alina</p>
                    </div>
                    ...
                    <div className="py-2">
                      <Link href="/login" onClick={() => setIsAccountOpen(false)}
                        ...
                        <div className="w-8 h-8 rounded-full bg-[#742709]/8 flex items-center justify-center shrink-0 group-hover:bg-[#742709]/15 transition-colors duration-200">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#742709" className="w-4 h-4">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m3 0 3-3m0 0-3-3m3 3H9" />
                          </svg>
                        </div>
                        <div>
                          <p className="text-[12px] font-semibold text-[#1C1B1B] tracking-wide group-hover:text-[#742709] transition-colors duration-200">Sign In</p>
                          <p className="text-[10px] text-[#1C1B1B]/40 tracking-wide">Access your account</p>
                        </div>
                      </Link>

                      <Link href="/register" onClick={() => setIsAccountOpen(false)}
                        className="flex items-center gap-3.5 px-5 py-3.5 group hover:bg-[#742709]/4 transition-colors duration-200">
                        <div className="w-8 h-8 rounded-full bg-[#742709]/8 flex items-center justify-center shrink-0 group-hover:bg-[#742709]/15 transition-colors duration-200">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#742709" className="w-4 h-4">
                        ...
                        <div>
                          <p className="text-[12px] font-semibold text-[#1C1B1B] tracking-wide group-hover:text-[#742709] transition-colors duration-200">Create Account</p>
                          <p className="text-[10px] text-[#1C1B1B]/40 tracking-wide">Join the Alina family</p>
                        </div>
                      </Link>
                    </div>
                ...
                {/* Wishlist */}
                <button onClick={() => setIsWishlistOpen(true)} aria-label={`Wishlist — ${totalWishlistItems} items`}
                ...
                {/* Cart */}
                <button onClick={() => setIsCartOpen(true)} aria-label={`Cart — ${totalItems} items`}
                  className="relative text-[#1C1B1B] hover:text-[#742709] transition-all duration-500 p-3 hover:bg-[#742709]/5 rounded-full group hover:scale-110 active:scale-95">
          ...
          {/* Mobile Search */}
          <div className={`md:hidden overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${isSearchOpen ? 'max-h-24 opacity-100' : 'max-h-0 opacity-0'}`}>
          ...
          {/* Mobile Menu */}
          <div className={`md:hidden overflow-hidden transition-all duration-700 ease-[cubic-bezier(0.4,0,0.2,1)] ${isMenuOpen ? 'max-h-[600px] opacity-100' : 'max-h-0 opacity-0'}`}>
              ...
              <div className="px-8 pt-6 pb-4 space-y-1">
                {navLinks.map((link, index) => (
                  <Link key={link.label} href={link.href} onClick={() => setIsMenuOpen(false)}
                    ...
                    style={{ animation: isMenuOpen ? `slideInRight 0.5s ease forwards ${index * 100}ms` : 'none', opacity: 0 }}>
                    {link.label}
      ...
      {/* Backdrop */}
      <div ref={overlayRef} onClick={() => { setIsCartOpen(false); setIsWishlistOpen(false); }}
        className={`fixed inset-0 z-50 bg-[#1C1B1B]/50 backdrop-blur-sm transition-all duration-700 overflow-hidden ease-[cubic-bezier(0.4,0,0.2,1)] ${
      ...
      <aside role="dialog" aria-modal="true" aria-label="Shopping cart"
        className={`fixed top-0 right-0 h-full z-50 w-full max-w-[440px] bg-[#FFFCF9] flex flex-col overflow-hidden shadow-2xl transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] ${isCartOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          ...
          {cartItems.length === 0 ? (
            ...
            <ul className="space-y-0">
              {cartItems.map((item, index) => (
                <li key={item.id} className="py-6 first:pt-0 last:pb-0 border-b border-[#742709]/8 last:border-0" style={{ animationDelay: `${index * 150}ms` }}>
      ...
      {/* ══ WISHLIST DRAWER ══ */}
      <aside role="dialog" aria-modal="true" aria-label="Wishlist"
        className={`fixed top-0 right-0 h-full z-50 w-full max-w-[440px] bg-[#FFFCF9] flex flex-col shadow-2xl transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] ${isWishlistOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex items-center justify-between px-8 py-7 border-b border-[#742709]/10 bg-gradient-to-r from-[#FFFCF9] to-[#F9F6F4]">
          <div>
