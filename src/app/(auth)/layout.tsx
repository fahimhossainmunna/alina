        ...
        <div className="relative z-10 flex flex-col justify-between w-full p-12 xl:p-16">
          ...
          <div className="max-w-md space-y-6">
            ...
            >
              Unveil Your
              <br />
              <em className="italic font-normal text-[#FFFCF9]/70">
                Natural Radiance
              </em>
            </motion.h2>
            ...
            >
              Experience pure organic luxury crafted for modern skincare
              rituals.
            </motion.p>
              ...
              {[
                ...
                >
                  <div className="w-[18px] h-[18px] rounded-full bg-[#FFFCF9]/15 border border-[#FFFCF9]/20 flex items-center justify-center shrink-0">
                    <svg
                      className="w-2.5 h-2.5 text-[#FFFCF9]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                  ...
                  <span className="text-[12px] text-[#FFFCF9]/80 tracking-wide">
                    {item}
                  </span>
                </motion.div>
              ))}
            ...
            >
              {[
                ...
                <div key={s.l}>
                  <p
                    className="text-[22px] font-semibold text-[#FFFCF9]"
                    style={{
                  ...
                  <p className="text-[9px] tracking-[0.3em] uppercase text-[#FFFCF9]/40 mt-0.5">
                    {s.l}
                  </p>
                </div>
              ))}
      ...
      <main className="flex-1 flex items-center justify-center px-6 sm:px-10 md:px-14 lg:px-16 py-12 md:py-0 bg-[#FFFCF9] relative overflow-y-auto md:min-h-screen">
        ...
        >
          ...
          <div className="block md:hidden text-center mb-6">
            <div className="inline-flex flex-col items-center gap-1.5 group">
              <span
                className="text-[24px] tracking-[0.3em] uppercase font-semibold text-[#742709]"
                style={{ fontFamily: "var(--font-playfair, Georgia, serif)" }}
              >
                Alina
              </span>
              <span className="text-[9px] tracking-[0.3em] uppercase text-[#1C1B1B]/35">
                Premium Collections
              </span>
            </div>
          </div>
          ...
          <div className="mt-4 flex items-center justify-center gap-5 text-[10px] tracking-[0.18em] uppercase text-[#1C1B1B]/28">
            <Link href="/privacy" className="hover:text-[#742709] transition-colors duration-300">
              Privacy
            </Link>
            <span className="opacity-40">·</span>
            <Link href="/terms" className="hover:text-[#742709] transition-colors duration-300">
              Terms
            </Link>
            <span className="opacity-40">·</span>
            <Link href="/contact" className="hover:text-[#742709] transition-colors duration-300">
              Contact
            </Link>
          </div>
        </motion.div>
