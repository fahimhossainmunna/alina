            ...
            {formData.password.length > 0 && (
              ...
              >
                ...
                <p className="text-[10px] text-[#1C1B1B]/40">
                  Strength:{" "}
                  <span
                    className={`font-medium ${strength >= 3 ? "text-green-600" : strength >= 2 ? "text-yellow-600" : "text-red-500"}`}
                  >
          ...
          <motion.div variants={itemVariants} className="pt-1">
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <span className="text-[12px] text-[#1C1B1B]/60 group-hover:text-[#1C1B1B] transition-colors leading-relaxed">
                ...
                <Link
                  href="/terms"
                  className="text-[#742709] font-medium hover:underline"
                >
                  Terms of Service
                </Link>{" "}
                and{" "}
          ...
          <div className="flex items-center gap-1.5 text-[10px]">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={1.5}
                d="M9 12H3.75M9 21H3.75a1.5 1.5 0 0 1-1.5-1.5V4.5A1.5 1.5 0 0 1 3.75 3H15a1.5 1.5 0 0 1 1.5 1.5v3m-9 9v3m0-3h3m9-9h3.75a1.5 1.5 0 0 1 1.5 1.5v10.5a1.5 1.5 0 0 1-1.5 1.5H15"
              />
            </svg>
            Global Tracking
          </div>
